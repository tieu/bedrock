...
(function() {
    ...
    /**
     * Detect whether the user's browser is Firefox for iOS. It does not follow same version numbers as desktop &
     * Android, so may not be safe to simply add this check to isFirefox. Will require further investigation/testing.
     *
     * @private
     * @param  {String} ua - browser's user agent string, navigator.userAgent is used if not specified
     * @return {Boolean} result
